...
```{r}
# setting the no. of burnin samples to 0 to plot all mcmc samples
results <- gibbs_har(y, X, n_iter = 10000, burnin = 0)

# Now results$beta contains all 10,000 iterations starting from iteration 1
plot(results$beta[, 1], type = "l", main = "Trace Plot with Burn-in")
```
